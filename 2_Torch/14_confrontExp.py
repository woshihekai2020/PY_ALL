#https://www.pytorch123.com/FourSection/AdversarialExampleGene/
#生成对抗示例
...
epsilons = [0, .05, .1, .15, .2, .25, .3]                   #epsilon越大，扰 动就越明显
...
test_loader = torch.utils.data.DataLoader(
                datasets.MNIST(rootDir, train=False, download=True, transform=transforms.Compose([transforms.ToTensor(),])),
                batch_size=1,
                shuffle=True)
# 定义我们正在使用的设备
