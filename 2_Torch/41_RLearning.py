#https://www.pytorch123.com/SeventhSection/ReinforcementLearning/
#强化学习（DQN）教程
import gym
#import pyglet
import math
...
#display.start()
############################################################################################################## 2:需要的包
#env = gym.make('CartPole-v0').unwrapped #raw
...
# no use, but same error
# https://github.com/openai/gym/issues/2068
#import gym
...
#plt.imshow(get_screen().gpu().squeeze(0).permute(1, 2, 0).numpy(), interpolation= InterpolationMode.BICUBIC )
plt.title('Example extracted screen')
plt.show()
#plt.waitforbuttonpress() #add hekai: 20231123
